  ...
  const sites = [
    {
      ...
      tags: ['Svelte', 'Animated Hero Design', 'Local SEO'],
    ...
    },
    {
      ...
      description: 'A modern restaurant website with dynamic menu management and a custom digital signage solution for two Metro Atlanta cafes.',
      tags: ['Svelte', 'Dynamic Menu Management', 'Digital Signage'],
    ...
    },
    {
      ...
      tags: ['Svelte', 'Visual Menu Design', 'Mobile-First'],
    ...
    },
    {
      ...
      description: 'A bespoke ticketing platform built from scratch for a local event venue — powered by Square.',
      tags: ['Svelte', 'Klaviyo Marketing', 'Square Ticketing Integration'],
